...
Angry_dir= os.path.join("expressions\angry")

# Directory with Happy images
Happy_dir= os.path.join("expressions\happy")

# Directory with Neutral images
Neutral_dir = os.path.join("expressions\neutral")

# Directory with Sad images
Sad_dir = os.path.join("expressions\sad")

# Directory with Surprise images
Surprise_dir = os.path.join("expressions\surprise")
...
train_generator = train_datagen.flow_from_directory("expressions....",  # This is the source directory for training images
